...
import { spotlightStories, testimonials } from "./data";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            A pioneering institution offering a balanced education in{" "}
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-4 text-slate-800 dark:text-slate-200">
                    <svg
                      className="w-8 h-8 text-slate-200 dark:text-slate-700 mb-2"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
