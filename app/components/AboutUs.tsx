...
import { Book, MousePointerClick, Globe, Users, Star, ClipboardCheck } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="inline-block">
            <span className="px-4 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full text-sm font-medium mb-4 inline-block">ABOUT US</span>
          </div>
          <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-6">
            Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600">New Iqra Techno</span>
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
            Founded on the principles of integrating Islamic values with modern education, 
            we strive to create a nurturing environment where students excel academically,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <motion.div variants={itemVariants}>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Our Story</h3>
              <p className="text-slate-600 dark:text-slate-300">
                New Iqra Techno English School (N.I.T) was established with a vision to provide 
                education that balances modern technological advancements with timeless Islamic 
                values. Our institution serves students from Junior KG to 12th grade, following 
                the CBSE curriculum.
              </p>
            </motion.div>
            
            <motion.div variants={itemVariants} className="border-l-4 border-green-600 pl-4 py-2">
              <p className="text-lg font-medium text-slate-800 dark:text-slate-200 italic">
                "We believe in nurturing not just intelligent minds, but compassionate hearts 
                and righteous character."
              </p>
            </motion.div>
            
            <motion.div variants={itemVariants}>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Our Approach</h3>
              <p className="text-slate-600 dark:text-slate-300">
                We take pride in our unique approach that integrates Quranic teachings and 
                modern subjects, preparing students to excel in both worldly pursuits and 
                spiritual growth. Our experienced faculty ensures that students receive 
                personalized attention and guidance throughout their educational journey.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 mb-6">
              To provide a comprehensive education that integrates Islamic principles with 
              modern knowledge, empowering students to become confident, responsible, and 
              successful individuals in both this world and the hereafter.
            </p>
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 mb-6">
              To be a leading educational institution that excels in providing holistic 
              education, producing graduates who are not only academically accomplished but 
              also spiritually grounded and socially responsible.
            </p>
        ...
        >
          <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Our Core Values</h3>
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-12">
            These principles guide everything we do at New Iqra Techno English School
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description: "We value the pursuit of both sacred and worldly knowledge, believing that true wisdom comes from integrating both."
            },
            {
              icon: MousePointerClick,
              title: "Faith & Character",
              description: "We nurture strong faith and exemplary character, teaching students to embody Islamic values in their daily lives."
            },
            {
              icon: Globe,
              title: "Innovation & Excellence",
              description: "We embrace technological innovation and strive for excellence in all academic and extracurricular endeavors."
            },
            {
              icon: Users,
              title: "Community & Belonging",
              description: "We foster a sense of community and belonging, where every student feels valued, respected, and supported."
            },
            {
              icon: Star,
              title: "Leadership & Service",
              description: "We develop leaders who are committed to serving their communities and making positive contributions to society."
            },
            {
              icon: ClipboardCheck,
              title: "Respect & Responsibility",
              description: "We uphold respect for diversity and personal responsibility, teaching students to be accountable for their actions."
            }
          ].map((value, index) => (
            <motion.div
              key={index}
